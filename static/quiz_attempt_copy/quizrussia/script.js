...
const questions = [{
    id: 0,
    question: "What is the traditional Russian soup made with beets called?",
    answers: [
        { text: "Borscht", isCorrect: true },
        { text: "Shchi", isCorrect: false },
        { text: "Solyanka", isCorrect: false },
        { text: "Okroshka", isCorrect: false }
    ],
...
{
    id: 1,
    question: "What is the name of the iconic cathedral in Moscow’s Red Square?",
    answers: [
        { text: "St. Peter's Basilica", isCorrect: false },
        { text: "St. Basil's Cathedral", isCorrect: true },
        { text: "Kazan Cathedral", isCorrect: false },
        { text: "Cathedral of Christ the Saviour", isCorrect: false }
    ],
    correctAnswer: "St. Basil's Cathedral"
},
{
    id: 2,
    question: "Which Russian leader is associated with the construction of the Trans-Siberian Railway?",
    answers: [
        { text: "Peter the Great", isCorrect: false },
        { text: "Catherine the Great", isCorrect: false },
        { text: "Alexander III", isCorrect: true },
        { text: "Vladimir Lenin", isCorrect: false }
    ],
    correctAnswer: "Alexander III"
},
{
    id: 3,
    question: "What is the Russian word for 'cheers'?",
    answers: [
        { text: "Salud", isCorrect: false },
        { text: "Kanpai", isCorrect: false },
        { text: "Na zdorovie", isCorrect: true },
        { text: "Prost", isCorrect: false }
    ],
    correctAnswer: "Na zdorovie"
}
];
