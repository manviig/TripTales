...
const questions = [{
    ...
    answers:
        ...
        { text: "30 million", isCorrect: false },
        { text: "80 million", isCorrect: false },
...
{
    id: 1,
    question: "Which season is popular for blooming cherry blossoms in South Korea?",
    answers:
...
{
    id: 2,
    question: "What can't you wear into a traditional Korean household?",
    answers:
        [{ text: "Shoes", isCorrect: true },
        { text: "Hat", isCorrect: false },
        { text: "Coat", isCorrect: false },
...

{
    ...
    answers:
        [{ text: "Bulgogi", isCorrect: false },
        { text: "Kimchi", isCorrect: true },
        { text: "Tteokbokki", isCorrect: false },
        { text: "Bibimbap", isCorrect: false }
        ],
...
{
    id: 4,
    question: "Which iconic landmark is in Seoul, South Korea?",
    answers:
        [{ text: "Eiffel Tower", isCorrect: false },
        { text: "N Seoul Tower", isCorrect: true },
        { text: "Statue of Liberty", isCorrect: false },
        { text: "Big Ben", isCorrect: false }
        ],
    correctAnswer: "N Seoul Tower"
